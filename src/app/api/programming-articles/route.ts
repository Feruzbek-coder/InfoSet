...
const dataFilePath = path.join(process.cwd(), 'src', 'data', 'programming-articles.json')
...
export async function GET() {
  try {
    ...
    console.error('Error reading programming articles:', error)
...
export async function POST(request: Request) {
  try {
    ...
    console.error('Error adding programming article:', error)
...
export async function PUT(request: Request) {
  try {
    ...
    console.error('Error updating programming article:', error)
...
export async function DELETE(request: Request) {
  try {
    ...
    console.error('Error deleting programming article:', error)
